...
public:
	...
	vector<bool> hasObstaclesInRow;
	vector<bool> hasObstaclesInColumn;
	...
	{
		int direction;
		std::vector<std::vector<int>> vectorpatterns{{},{} ,{} ,{} };
		...
		while (iter != undecidednodesDeque.end())
		{
			...
			direction = figurePattern(vectorpatterns);
